...
// Product Module
router.post('/addProduct', restaurantUpload.fields([{ name: 'image', maxCount: 1 }, { name: 'bannerImage', maxCount: 1 }]), asyncMiddleware(restController.addProduct));
router.post('/editProduct', restaurantUpload.fields([{ name: 'image', maxCount: 1 }, { name: 'bannerImage', maxCount: 1 }]),asyncMiddleware(restController.editProduct));
...
router.get('/allCuisines', asyncMiddleware(restController.allCuisines));
